...
document.addEventListener('DOMContentLoaded', function(e) {
	...
	document.addEventListener('click', function (event) {
		...
		if (event.target.matches('.tab-link')) {
			...
			followContainer.innerHTML = '\
				...
				<div class="socialCell">\
					<a href="https://www.instagram.com/gmet3" target="_blank">\
  ...
  /* =========================
     Product screenshots slider + lightbox
     Works only if #screenshots exists on the page
     ========================= */
  (function initScreenshots(){
    ...
    document.addEventListener('keydown', function(ev){
      if(ev.key === 'Escape' && lb.classList.contains('is-open')) closeLB();
    });
  })();
